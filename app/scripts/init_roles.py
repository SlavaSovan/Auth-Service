...
async def init_permissions(db) -> dict:
    ...
    permissions_config = [
        ...
        {
            "name": "project:read:any",
            "description": "View any project",
            "category": "project",
        },
        {
            "name": "project:write:own",
            "description": "Edit own projects",
            "category": "project",
        },
        {
            "name": "project:write:any",
            "description": "Edit any project",
            "category": "project",
        },
        {"name": "task:read:own", "description": "View own tasks", "category": "task"},
        {"name": "task:read:any", "description": "View any task", "category": "task"},
        {"name": "task:write:own", "description": "Edit own tasks", "category": "task"},
        {"name": "task:write:any", "description": "Edit any task", "category": "task"},
        {
            "name": "document:read:own",
            "description": "View own documents",
            "category": "document",
        },
        {
            "name": "document:read:any",
            "description": "View any document",
            "category": "document",
        },
    ]
    ...
    if not defaul_role:
        if not user_role:
            user_permission_ids = [
                ...
                permissions_map["project:read:own"],
                permissions_map["task:read:own"],
                permissions_map["document:read:own"],
            ]
